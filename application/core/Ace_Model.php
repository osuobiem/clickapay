 ...
 * Ace_Model Class
 * 
 * Database model layer to interact with
...
class Ace_Model extends CI_Model {
  ...
  // Many-to-One-to-One-to-Many entity relationship declaration array
  protected $foreign;

  // Many-to-Many entity relationship declaration array
  protected $relation;
   ...
   * 
   * @param array|string (oprional) $options   Associative array or 
   *                                           string of filters
